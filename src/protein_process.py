...
# now we have the updated version of the compartment 20260407
...
def gene_location_curation_sce(organelle0):
    ...
    gene_lipid_droplet = pd.read_excel("data/sce_compartment_curation/2026_curated/lipid_droplet_annotations.xlsx")
    ...
    nucleoplasm_gene_double_check = pd.read_excel("data/sce_compartment_curation/2026_curated/nucleoplasm_annotation.xlsx")
    ...
    for y in organelle1.keys():
        ...
        if y == "plasma membrane":
            ...
            genes_select = nucleoplasm_gene_double_check['gene']
        elif y == "lipid droplet":
            genes_select = gene_lipid_droplet["gene"].tolist()
        else:
            genes_select = organelle1[y]
...
def ProMassRatio_Organelle(protein_abundance, compartment):
    """
