...
os.chdir('/Users/luho/Documents/GitHub/De-nevo-protein-3D-structure-yeast/code')
...
def preprocessResidueHOMO(chain0, start1, end1):
    ...
    # note: after this step, residue_one1[0] = chain0[1] as chain0 only start from 1
...
infile = '/Users/luho/Documents/GitHub/De-nevo-protein-3D-structure-yeast/pdb_itasser.xlsx'
#read meta data for one group of structure
pdb_sce = pd.read_excel(infile)
pdb_sce['coordinate_id0'] =pdb_sce['pdbid']#pdb_sce['mapid'] + '.pdb'
...
pdbfile = '/Users/luho/Documents/GitHub/De-nevo-protein-3D-structure-yeast/pdb_itasser_structure_mapping/'
...
for i in range(0, len(pdb_inf['coordinate_id0'])):
    ...
    infile = pdbfile + pdbID + '.pdb'
    outfile = '/Users/luho/Google Drive/R application and code/protein 3D structure QC and QA/Evolution analysis/residue_distance/pdb_homo/' + pdbID + '.pdb.txt'
...
# Note
# The followed code is not used for the model built by ITASSER
