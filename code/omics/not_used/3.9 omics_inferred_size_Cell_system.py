...
for col0 in Sample_ID_select:
    ...
    result1[col0] = value1
    result2[col0] = value2
result1.to_excel("data/proteomics/volume_size_across_compartment_cell_systems_2017.xlsx")
result2.to_excel("data/proteomics/membrane_size_across_compartment_cell_systems_2017.xlsx")
