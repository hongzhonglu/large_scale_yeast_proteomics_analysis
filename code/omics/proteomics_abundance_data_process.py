...
abundance.to_excel("data/abundance_paxdb.xlsx")
...
# Some species process. It could find that some rows with two proteins. Here assume the two proteins are identical in abundance.
