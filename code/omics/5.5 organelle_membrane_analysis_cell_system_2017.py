...
membrane_size = pd.read_excel("data/proteomics/membrane_size_across_compartment_cell_systems_2017.xlsx") # curated based on cell size under different growth rate
...
membrane_size_1 = membrane_size_tr0.iloc[2:12,:]
...
for y0 in column_select10:
    title0 = 'result/figure/cell_systems_2017_' + y0 + '.pdf'
    print(title0)
    plt.figure()
