...
###########################################################################
# get the used enzyme list under selected condition
...
def used_enzyme_per_protein_from_organelle(protein_abundance, enzyme_list=used_enzyme_dict, compartment_type="organelle"):
    """
    ...
    test_condition = list(enzyme_list.keys())
    Sample_ID_select = list(set(Sample_ID_select) & set(test_condition))
    ...
    for col0 in Sample_ID_select:
        ...
        for y in all_compartment:
            ...
            pro_select_enzyme = pro_select[pro_select['gene'].isin(enzyme_list[col0])]
