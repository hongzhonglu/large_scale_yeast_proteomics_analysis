...
# the protein location here is based on manual check, but it contains annotation from computation!! It is not used currently.
...
# all_compartment = ['fungal-type vacuole']
gene_fungal_type_vacuole = pd.read_excel("data/gene_belong_fungal_type_vacuole_annotations.xlsx")
