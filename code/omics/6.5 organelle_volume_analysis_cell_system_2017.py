...
volume_size = pd.read_excel("data/proteomics/volume_size_across_compartment_cell_systems_2017.xlsx") # curated based on cell size under different growth rate
...
protein_copy_all1 = pd.read_excel("data/proteomics/protein_copy_from_cell_systems_2017_scale.xlsx")
...
combine_data2["sample_ID"] = list(combine_data2.index)
...
for y0 in column_select1:
    title0 = 'result/figure/cell_system_2017_' + y0 + '.pdf'
    print(title0)
    plt.figure()
