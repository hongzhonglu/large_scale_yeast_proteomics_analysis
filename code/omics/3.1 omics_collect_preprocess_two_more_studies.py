...
proteomics_NCB2.columns = ["Entry","geneID","sce_FY4_batch"]

# relative data, change it as the absolute value
...
proteomics_NCB3["ref_abs"] = multiMapping(proteomics_NCB2["sce_FY4_batch"],proteomics_NCB2["Entry"],proteomics_NCB3["Entry"])
...
target_column = list(proteomics_NCB3.columns)[2:14]
proteomics_NCB30 = proteomics_NCB3[["Entry"]+target_column]
for xx in target_column:
    print(xx)
    proteomics_NCB30[xx] = proteomics_NCB3.ref_abs * proteomics_NCB3[xx]
# unify the name
target_column0 = ["sce_FY4_" + x for x in target_column]
proteomics_NCB30.columns = ["Entry"] + target_column0
