...
membrane_size_Jianye = membrane_size_tr0[membrane_size_tr0.index.str.contains("_M")]

membrane_size_Jianye["sample_ID"] = list(membrane_size_Jianye.index)
# combine the physiological datasets and proteomics datasets
combine_data = pd.merge(left=membrane_size_Jianye, right=physiology_Jianye, left_on=['sample_ID'], right_on=['kinetic'], how="left")
